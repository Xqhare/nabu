# XFF v4 Byte-Map Reference

This document provides the complete 8-bit byte mapping for all markers and type identifiers in the .xff version 4 specification.

## Overview
The XFF v4 byte-map is a part of the two-tier integrity system. Every marker byte defined below maintains **even parity** via its most significant bit (MSB).
...
- **Simple Values (Group 00)**: Logical* (0/8) vs. Maths* (1/9) - *Loose alignment for Hamming distance*
...
| :---: | :---: | :--------: | :---: | :---: | :---: | :---: | :-- | :---: |
| 0 | 00 | 0 00 00000 | 0 | 00 | 00000 | **NUL** | Null / Infinity | Simple |
...
| 5 | 05 | 0 00 00101 | 0 | 00 | 00101 | -- | Unused | Simple |
| 6 | 06 | 0 00 00110 | 0 | 00 | 00110 | -- | Unused | Simple |
| 135 | 87 | 1 00 00111 | 1 | 00 | 00111 | **TRU** | True / Negative Infinity | Simple |
...
| 153 | 99 | 1 00 11001 | 1 | 00 | 11001 | **FAL** | False / Positive NaN | Simple |
...
| 30 | 1E | 0 00 11110 | 0 | 00 | 11110 | **NAN** | NaN (Quiet) / Negative NaN | Simple |
...
| 36 | 24 | 0 01 00100 | 0 | 01 | 00100 | **DT** | DateTime (UTC) | Complex |
| 165 | A5 | 1 01 00101 | 1 | 01 | 00101 | **ASCI** | ASCII-TEXT (7-bit) | Complex |
| 166 | A6 | 1 01 00110 | 1 | 01 | 00110 | **LDT** | LocalDateTime | Complex |
| 39 | 27 | 0 01 00111 | 0 | 01 | 00111 | **LD** | LocalDate | Complex |
| 40 | 28 | 0 01 01000 | 0 | 01 | 01000 | **LT** | LocalTime | Complex |
...
| 183 | B7 | 1 01 10111 | 1 | 01 | 10111 | **CFLT** | Custom Decimal Float | Complex |
...
| 189 | BD | 1 01 11101 | 1 | 01 | 11101 | **SINT** | Signed Integer | Complex |
| 190 | BE | 1 01 11110 | 1 | 01 | 11110 | **UINT** | Unsigned Integer | Complex |
...
| 221 | DD | 1 10 11101 | 1 | 10 | 11101 | **GRPH** | Graph | Parent |
