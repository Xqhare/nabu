...
> [!note]
> ***This version is not yet finalized. The reference implementation is not yet available.***
...
For the complete reference of all 128 marker bytes, including binary values and reserved slots, see the [XFF v3 Byte-Map Reference](xff-v3-byte-map.md).
