...
## Strings
A valid `String` is a sequence or single character of a set of [ASCII](xff-byte-encoding.md) characters. Only characters `8`-`13`, `32`-`126`, `128`, `130`-`140`, `142`, `145`-`156`, `158`-`255` are permissible.
