...
## Checksum
> [!important]
> Any implementation of this specification should read and check the correctness of the checksum of the entire file, as well as the checksum of single values.
> It must be able however, to generate and write the correct checksum of the entire file, as well as of single values, if it is able to write.
